...
func Demo2() {
	credit1 := Mortgage{rate: 10, creditPaymentTotal: 100000, adress: "Bruxelles"}
	credit2 := Mortgage{rate: 12, creditPaymentTotal: 50000, adress: "Namur"}
	credit3 := Car{rate: 15, creditPaymentTotal: 60000, carInfo: "Vw Golf7"}

	credits := []CreditCalculator{credit1, credit2, credit3}
	total := CalculateMonthlyPayment(credits)

	fmt.Println("Le paiement total : ", total)
